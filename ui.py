...
class HudCanvas(QWidget):
    def __init__(self, face_path: str, assistant_name: str = "SARANA", parent=None):
...
class FileDropZone(QWidget):
    ...
    def _browse(self):
        path, _ = QFileDialog.getOpenFileName(
            self, "Select a file for SARANA", str(Path.home()),
            "All Files (*.*);;"
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(_lbl("Configure SARANA before first boot.", 9, color=C.PRI_DIM))
        layout.addSpacing(6)
...
class CustomizeOverlay(QWidget):
    ...
    def __init__(self, assistant_name="SARANA", user_name="",
    ...
    def _save(self):
        name = self._name_input.text().strip() or "SARANA"
...
class RemoteKeyOverlay(QWidget):
    ...
    def mark_connected(self) -> None:
        ...
        self._timer_lbl.setText("Phone connected — SARANA ready")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        ...
        self._assistant_name: str = (_cfg.get("assistant_name") or "SARANA").strip()
        ...
        self.setWindowTitle(f"{_display} — SARANA")
    ...
    def _build_header(self) -> QWidget:
        ...
        lay.addWidget(_badge("SARANA", C.PRI_DIM))
        lay.addSpacing(8)
    ...
    def _open_customize(self):
        ...
        cw = self.centralWidget()
        ov = CustomizeOverlay(
            cfg.get("assistant_name", "SARANA") or "SARANA",
            cfg.get("user_name", ""),
    ...
    def _apply_name_update(self, name: str, user_name: str, ui_color: str = ""):
        ...
        self._assistant_name = name.strip() or "SARANA"
