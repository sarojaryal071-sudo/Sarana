...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "from my desktop', never 'delete the old files'); for a repository action name the "
            "SPECIFIC search term or file ('edit main.py to add logging', never 'fix the project') "
            "— JARVIS will not invent a cell/file/target you didn't specify. "
