...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "hard reset are permanently unsupported and will be refused, never attempted). For "
            "anything this doesn't yet cover, use the specific existing tool for that instead (this "
            ...
            "quotes ('commit these changes with message \"Fix login bug\"', never just 'commit') "
            "— JARVIS will not invent a cell/file/target/message you didn't specify. "
